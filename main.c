...
/* This function is associated with the "P1" thread/process
 * described in Part II of the rubric.
 */
...
/* This function is associated with the "P2" and "P3" threads/processes
 * described in Part II of the rubric. Both do the same operations, but
 * on different files. arg is a char * that contains the file name.
 */
